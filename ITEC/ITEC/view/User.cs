...
namespace ITEC.view
{
    public partial class User : Form
    {
        ...
        public class Group : GroupBox
        {
            ...
            {
                sessionUser = parent.ctr.getSessionUser();
                ...
                if (sessionUser.groups1.Contains(getGroupObject()))
                {
                ...
                {
                    btn.BackgroundImage = Image.FromFile("../../ico/index.jpg");
                    btn.FlatStyle = FlatStyle.Flat;
                    btn.FlatAppearance.BorderSize = 0;
                    btn.Size = new Size(16, 16);
                    btn.Location = new Point(480, 25);
            ...
            private void btn_click(object o, EventArgs e) {
                gr.users.Add(sessionUser);
                parent.ctr.commitChanges();
        ...
        {
            WelcomeMessage wel = new WelcomeMessage(((user)ctr.getSessionUser()).welcome_msg);
            wel.StartPosition = FormStartPosition.CenterScreen;
            wel.Show();
            Util.Animate(wel, Util.Effect.Blend, 5000, 3);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                itemId = (int)lw_items.SelectedItems[0].Tag;
            }
            catch (Exception ex) {
            ...
            it.points += (int)Math.Floor(numericUpDown1.Value);
            sessionUser.no_points -= int.Parse(numericUpDown1.Value.ToString());
            ctr.commitChanges();
            pointsTb.Text = sessionUser.no_points.ToString();
            loadItems((int)cmbx_categories.SelectedValue);
        }
